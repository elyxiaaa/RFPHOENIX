...
import CharacterImage from '../assets/CHAR/CORA/BGR.jpg'// Replace with actual character image path
import Helm from '../assets/CHAR/CORA/ITEM/LR/Helm.png'; // Replace with actual gear image path
import Upper from '../assets/CHAR/CORA/ITEM/LR/Upper.png'
import Lower from '../assets/CHAR/CORA/ITEM/LR/Lower.png'
import Shoes from '../assets/CHAR/CORA/ITEM/LR/Shoes.png'
import Gloves from '../assets/CHAR/CORA/ITEM/LR/Gloves.png'
import Spear from '../assets/CHAR/CORA/ITEM/LR/Bow.png'
import Glider from '../assets/CHAR/CORA/ITEM/LR/Glider.png'
...
<div className="text-black  p-6 rounded-lg">
  ...
  <div className="text-center">
                  <p className="text-lg font-semibold mt-4">5 Parts Set Effects:</p>
                        ...
                        <p className="text-lg"><strong>Resistance</strong>: 15% Increase (Sec)</p>
                    </div>
                    <div className="text-center">
