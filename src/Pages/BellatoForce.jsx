...
import CharacterImage from '../assets/CHAR/BELLATO/BGF.jpg'// Replace with actual character image path
import Helm from '../assets/CHAR/BELLATO/ITEM/FR/Helm.png'; // Replace with actual gear image path
import Upper from '../assets/CHAR/BELLATO/ITEM/FR/Upper.png'
import Lower from '../assets/CHAR/BELLATO/ITEM/FR/Lower.png'
import Shoes from '../assets/CHAR/BELLATO/ITEM/FR/Shoes.png'
import Gloves from '../assets/CHAR/BELLATO/ITEM/FR/Gloves.png'
import Spear from '../assets/CHAR/BELLATO/ITEM/FR/Staff.png'
import Glider from '../assets/CHAR/BELLATO/ITEM/FR/Glider.png'
import { Link } from 'react-router-dom';

function BellatoForce() {
...
<div className="text-black  p-6 rounded-lg">
  ...
  <div className="flex justify-between space-x-4">
    <div className="text-center">
      ...
      <p className="text-lg font-bold">Force</p>
    </div>
    <div className="text-center">
  ...
  <div className="flex justify-between space-x-4">
                     <div className="text-center">
                      ...
                      <p className="text-lg"><strong>Force Attack</strong>: 15% Increase</p>
                      <p className="text-lg"><strong>Defense</strong>: 15% Increase</p>
                      <p className="text-lg"><strong>HP</strong>: 10% Increase</p>
                      <p className="text-lg"><strong>Force Range</strong>: 10 Increase</p>
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-lg"><strong>Force Attack</strong>: 5% Increase</p>
