...
import CharacterImage from '../assets/CHAR/BELLATO/BGW.jpg'// Replace with actual character image path
import Helm from '../assets/CHAR/BELLATO/ITEM/CR/Helm.png'; // Replace with actual gear image path
import Upper from '../assets/CHAR/BELLATO/ITEM/CR/Upper.png'
import Lower from '../assets/CHAR/BELLATO/ITEM/CR/Lower.png'
import Shoes from '../assets/CHAR/BELLATO/ITEM/CR/Shoes.png'
import Gloves from '../assets/CHAR/BELLATO/ITEM/CR/Gloves.png'
import Spear from '../assets/CHAR/BELLATO/ITEM/CR/Spear.png'
import Glider from '../assets/CHAR/BELLATO/ITEM/CR/Glider.png'
import { Link } from 'react-router-dom';

function BellatoWarrior() {
      ...
      <div className="relative flex justify-center items-center z-10">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center p-8 w-full mt-20">
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="relative border-4 border-blue-400 rounded-xl shadow-lg">
  ...
  <img src={CharacterImage} alt="Character" className="w-128 h-auto z-10 rounded-lg" />
            ...
            <div className="relative flex justify-center items-center space-x-4 ">
              {/* Gear 1 */}
              <div className="w-24 h-24 bg-GearBG2 bg-center bg-cover rounded-full flex justify-center items-center">
                <img
                  src={Helm}
                  alt="Gear"
                  className="w-20 h-20"
...
<div className="text-black  p-6 rounded-lg">
  <h2 className="text-3xl text-center font-bold mb-4">Bellato Apex Armor</h2>
  <div className="flex justify-between space-x-4">
    <div className="text-center">
      <p className="text-lg">Class</p>
      <p className="text-lg font-bold">Warrior</p>
    </div>
    <div className="text-center">
  ...
  <div className="flex justify-between space-x-4">
      <div className="text-center">
        <p className="text-lg font-semibold mt-4">Set Effects:</p>
        <p className="text-lg"><strong>Attack</strong>: 10% Increase</p>
        <p className="text-lg"><strong>Defense</strong>: 20% Increase</p>
        <p className="text-lg"><strong>HP</strong>: 10% Increase</p>
        <p className="text-lg">Attack Delay of Skill Attack is 0.02 Decrease (Sec)</p>
      </div>
      <div className="text-center">
          <p className="text-lg font-semibold mt-4">3 Parts Set Effects:</p>
          <p className="text-lg"><strong>Attack</strong>: 10% Increase</p>
          <p className="text-lg"><strong>Defense</strong>: 10% Increase</p>
      </div>
  </div>
...
<div className="text-black p-6 rounded-lg">
  <h2 className="text-3xl text-center font-bold mb-4">Bellato Apex Weapon</h2>
  <div className="flex justify-between space-x-4">
    <div className="text-center">
      <p className="text-lg">Class</p>
      <p className="text-lg font-bold">Warrior</p>
