...
import CharacterImage from '../assets/CHAR/BELLATO/BGR.jpg'// Replace with actual character image path
import Helm from '../assets/CHAR/BELLATO/ITEM/LR/Helm.png'; // Replace with actual gear image path
import Upper from '../assets/CHAR/BELLATO/ITEM/LR/Upper.png'
import Lower from '../assets/CHAR/BELLATO/ITEM/LR/Lower.png'
import Shoes from '../assets/CHAR/BELLATO/ITEM/LR/Shoes.png'
import Gloves from '../assets/CHAR/BELLATO/ITEM/LR/Gloves.png'
import Spear from '../assets/CHAR/BELLATO/ITEM/LR/Gun.png'
import Glider from '../assets/CHAR/BELLATO/ITEM/LR/Glider.png'
import { Link } from 'react-router-dom';

function BellatoRanger() {
...
<div className="text-black  p-6 rounded-lg">
  ...
  <div className="flex justify-between space-x-4">
    <div className="text-center">
      ...
      <p className="text-lg font-bold">Ranger</p>
    </div>
    <div className="text-center">
  ...
  <div className="text-center">
                  <p className="text-lg font-semibold mt-4">5 Parts Set Effects:</p>
                        ...
                        <p className="text-lg"><strong>Avoidance</strong>: 15 Increase</p>
                        <p className="text-lg"><strong>Resistance</strong>: 15% Increase</p>
                    </div>
                    <div className="text-center">
                        ...
                        <p className="text-lg"><strong>Avoidance</strong>: 5 Increase</p>
                  </div>
  </div>
